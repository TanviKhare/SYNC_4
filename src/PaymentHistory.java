...
public class PaymentHistory extends javax.swing.JFrame {
    ...
    public PaymentHistory(String data,boolean user) {
        initComponents();
        try{
     ...
     */
    void seeDetails(String data,boolean user)
    {
        String query;
        if(!user)
        {
            query = "SELECT billid,userName as username,units,amount,month,year,generated_on,paid_on FROM bills WHERE location = '"+data+"' AND paid = true ORDER BY(paid_on) DESC;";
        }else{
            query = "SELECT billid,units,amount,month,year,paid_on FROM bills WHERE userName = '"+data+"' AND paid = true ORDER BY(paid_on) DESC;";
        }
        ...
        {
            e.printStackTrace();
            System.out.println("Error occured while retreiving Payment History!");
            setVisible(false);
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 123, 618, 293));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 720, 440));
